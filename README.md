...
<html xml:lang="EN" xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head>
		...
		<style type="text/css"> #myContainer { width:5100px; height:3200px; margin:auto; border:1px; border-style:solid; border-color:#696969;} </style>
		<script type="text/javascript"> Z.showImage("myContainer", "3", "zNavigatorVisible=0"); </script>
	</head>
	<body bgcolor=#000000>
		<br>
